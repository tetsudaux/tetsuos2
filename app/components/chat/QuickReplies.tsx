    ...
    <div className="flex flex-row flex-wrap justify-end gap-3 lg:gap-4">
      {replies.map((reply, index) => (
        <button
          ...
          disabled={disabled}
          className="btn-hover-lift animate-fade-in-up flex items-center gap-3 border-2 border-[var(--ir-700)] bg-[var(--background-subtle)] px-4 py-3 font-semibold text-[var(--ir-700)] transition-all hover:bg-[var(--ir-700)] hover:text-white disabled:cursor-not-allowed disabled:opacity-50 lg:px-5 lg:py-3.5"
          style={{ 
